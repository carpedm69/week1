...
{"in": 9}
EOT
snarkjs wtns calculate LessThan10/LessThan10_js/LessThan10.wasm input.json witness.wtns
snarkjs groth16 prove LessThan10/circuit_final.zkey witness.wtns proof.json public.json
