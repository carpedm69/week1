...
# proof and withness calculation
cat <<EOT > input.json
{"in": 9, "range": [3, 10]}
EOT
snarkjs wtns calculate RangeProof/RangeProof_js/RangeProof.wasm input.json RangeProof/witness.wtns
snarkjs groth16 prove RangeProof/circuit_final.zkey RangeProof/witness.wtns RangeProof/proof.json RangeProof/public.json
